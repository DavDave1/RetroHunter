...
public static class GameSystemData
{
    ...
    public static string Name(this GameSystemType type)
    {
        return type switch
        {
            ...
            GameSystemType.MagnavoxOdissey2 => "Magnavox Odissey 2",
    ...
    public static RomMatcherType Matcher(this GameSystemType type)
    {
        return type switch
        {
            GameSystemType.GameBoy => RomMatcherType.Md5,
            GameSystemType.GameBoyColor => RomMatcherType.Md5,
            GameSystemType.GameBoyAdvance => RomMatcherType.Md5,
            GameSystemType.Nes => RomMatcherType.Nes,
            GameSystemType.SuperNintendo => RomMatcherType.Snes,
            GameSystemType.Nintendo64 => RomMatcherType.Nintendo64,
            GameSystemType.GameCube => RomMatcherType.GameCube,
            GameSystemType.NintendoDS => RomMatcherType.NintendoDS,
            GameSystemType.NintendoDSi => RomMatcherType.NintendoDS,
            GameSystemType.PokemonMini => RomMatcherType.Md5,
            GameSystemType.VirtualBoy => RomMatcherType.Md5,
            GameSystemType.PlayStation => RomMatcherType.Ps1,
            GameSystemType.PlayStation2 => RomMatcherType.Ps2,
            GameSystemType.Psp => RomMatcherType.Psp,
            GameSystemType.Atari2600 => RomMatcherType.Md5,
            GameSystemType.Atari7800 => RomMatcherType.Atari7800,
            GameSystemType.AtariJaguar => RomMatcherType.Md5,
            GameSystemType.AtariJaguarCD => RomMatcherType.AtariJaguarCD,
            GameSystemType.AtariLynx => RomMatcherType.AtariLynx,
            GameSystemType.Sg1000 => RomMatcherType.Md5,
            GameSystemType.MasterSystem => RomMatcherType.Md5,
            GameSystemType.GameGear => RomMatcherType.Md5,
            GameSystemType.Genesis => RomMatcherType.Md5,
            GameSystemType.SegaCD => RomMatcherType.SegaCD,
            GameSystemType.Sega32x => RomMatcherType.Md5,
            GameSystemType.Saturn => RomMatcherType.Saturn,
            GameSystemType.Dreamcast => RomMatcherType.Dreamcast,
            GameSystemType.PcEngine => RomMatcherType.PcEngine,
            GameSystemType.PcEngineCD => RomMatcherType.PcEngineCD,
            GameSystemType.Pc8000 => RomMatcherType.Md5,
            GameSystemType.PcFx => RomMatcherType.Md5,
            GameSystemType.NeoGeoCD => RomMatcherType.NeoGeoCD,
            GameSystemType.NeoGeoPocket => RomMatcherType.Md5,
            GameSystemType.ThreeDo => RomMatcherType.ThreeDO,
            GameSystemType.AmstradCPC => RomMatcherType.Md5,
            GameSystemType.AppleII => RomMatcherType.Md5,
            GameSystemType.Arcade => RomMatcherType.FileNameHash,
            GameSystemType.Arcadia2001 => RomMatcherType.Md5,
            GameSystemType.Arduboy => RomMatcherType.Arduboy,
            GameSystemType.ColecoVision => RomMatcherType.Md5,
            GameSystemType.ElektorTvGamesComputer => RomMatcherType.Md5,
            GameSystemType.FairchildChannelF => RomMatcherType.Md5,
            GameSystemType.Intellivision => RomMatcherType.Md5,
            GameSystemType.IntertonVC4000 => RomMatcherType.Md5,
            GameSystemType.MagnavoxOdissey2 => RomMatcherType.Md5,
            GameSystemType.MegaDuck => RomMatcherType.Md5,
            GameSystemType.Msx => RomMatcherType.Md5,
            GameSystemType.Uzebox => RomMatcherType.Md5,
            GameSystemType.Vectrex => RomMatcherType.Md5,
            GameSystemType.Wasm4 => RomMatcherType.Md5,
            GameSystemType.Supervision => RomMatcherType.Md5,
            GameSystemType.WonderSwan => RomMatcherType.Md5,
    ...
    public static string FolderName(this GameSystemType type, DirStructureStyle style)
    {
        return style switch
        {
            ...
            DirStructureStyle.EmuDeck => type switch
            {
                ...
                GameSystemType.MagnavoxOdissey2 => "odyssey2",
    ...
    public static List<string> Extensions(this GameSystemType type)
    {
        return type switch
        {
            ...
            GameSystemType.MagnavoxOdissey2 => [".bin"],
